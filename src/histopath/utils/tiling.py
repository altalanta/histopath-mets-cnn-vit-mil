...
class WSITiler:
    ...
    def get_tile_coordinates(
        self, slide_path: str, tissue_mask: np.ndarray = None
    ...
    def extract_tile(
        self, slide_path: str, x: int, y: int, level: int = 0
    ) -> Image.Image:
        """
        ...
        try:
            ...
            tile = slide.read_region(
                (x_level0, y_level0), level, (self.tile_size, self.tile_size)
            )
    ...
    def extract_tiles_generator(
        self, slide_path: str, coordinates: List[Tuple[int, int, int]]
